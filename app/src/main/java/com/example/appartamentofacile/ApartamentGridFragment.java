...
public class ApartamentGridFragment extends Fragment {
    ...
    public View onCreateView(
        ...
        ApartamentCardRecyclerViewAdapter adapter = new ApartamentCardRecyclerViewAdapter(
                ProductEntry.initProductEntryList(getResources()));
        recyclerView.setAdapter(adapter);
        int largePadding = getResources().getDimensionPixelSize(R.dimen.shr_product_grid_spacing);
        int smallPadding = getResources().getDimensionPixelSize(R.dimen.shr_product_grid_spacing_small);
        recyclerView.addItemDecoration(new ApartamentGridItemDecoration(largePadding, smallPadding));
